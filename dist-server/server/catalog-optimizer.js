 ...
 */
async function scrapeRaiseDeals() {
 ...
 */
async function scrapeCardCashDeals() {
 ...
 */
export async function getAllAffiliateDeals() {
 ...
 */
export function filterByMargin(deals, minMarginPercent = 5) {
 ...
 */
export function selectBestDeals(deals) {
 ...
 */
export async function addRewardsToCatalog(deals) {
    let added = 0;
    for (const deal of deals) {
 ...
 */
export async function removeLowMarginRewards(minMarginPercent = 3) {
