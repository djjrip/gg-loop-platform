...
export async function findRiotStreamers() {
...
export async function findStreamerEmail(twitchUsername) {
...
export function generatePartnershipEmail(streamerName, game) {
    return {
...
export async function sendPartnershipEmail(to, streamerName, game) {
