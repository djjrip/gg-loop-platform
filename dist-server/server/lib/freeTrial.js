 ...
 */
export async function activateFreeTrial(userId) {
 ...
 */
export async function checkTrialExpiration(userId) {
 ...
 */
export function getTrialReminderMessage(daysRemaining) {
    if (daysRemaining === 1) {
 ...
 */
export function calculateTrialValue(pointsEarned) {
 ...
 */
export function getPostTrialMessage(totalPoints) {
