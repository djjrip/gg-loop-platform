 ...
 */
export async function backfillSponsors() {
    ...
    const uniqueSponsorNames = new Map();
    ...
    const sponsorIdMap = new Map(); // sponsorName -> sponsorId
 ...
 */
export async function syncSponsorBudgets() {
