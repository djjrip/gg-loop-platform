 ...
 */
export async function alertFounderRedemption(data) {
 ...
 */
export async function alertFounderNewUser(userEmail, userId) {
 ...
 */
export async function alertFounderNewSubscription(userEmail, tier, amount) {
