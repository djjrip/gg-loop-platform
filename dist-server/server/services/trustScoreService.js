...
export class TrustScoreService {
    ...
    static async calculateTrustScore(userId) {
        ...
        const components = { base: SCORE_CONFIG.BASE_REGISTERED };
        const reasons = ["Account Registered"];
     ...
     */
    static async logEvent(userId, eventType, delta, reason, source = 'system') {
        // 1. Log the event
