...
export class GameService {
     ...
     */
    async fetchPlayerStatsFromProvider(playerId) {
     ...
     */
    async fetchLeaderboardFromProvider(period) {
    ...
    async fetchValveStats(playerId) {
    ...
    async fetchBlizzardStats(playerId) {
    ...
    async fetchCustomStats(playerId) {
