...
// ============================================
function generateAffiliateEmail(streamerName, game) {
...
// ============================================
export async function runCompleteOutreach(streamers) {
    ...
    for (const streamer of streamers) {
        ...
        // Step 3: Send email
        const sent = await sendEmailViaSendGrid(email, emailContent.subject, emailContent.html, emailContent.text);
        results.push({
            username: streamer.username,
            email,
            sent,
