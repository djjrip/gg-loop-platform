...
function getTwitchRedirectUri(hostname) {
...
export function setupTwitchAuth(app) {
    ...
    app.get('/api/auth/twitch/link', isAuthenticated, (req, res) => {
    ...
    app.get('/api/settings/twitch/callback', isAuthenticated, async (req, res) => {
    ...
    app.post('/api/auth/twitch/unlink', isAuthenticated, async (req, res) => {
        try {
            const oidcSub = req.user.claims.sub;
