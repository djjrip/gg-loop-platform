 ...
 * Record user login
 */
export function recordLogin(provider, success) {
    userLoginCounter.inc({ oauth_provider: provider, status: success ? 'success' : 'failure' });
}
/**
 * Record user registration
 */
export function recordRegistration(provider) {
    userRegistrationsCounter.inc({ oauth_provider: provider });
}
/**
 * Record revenue
 */
export function recordRevenue(source, amountUSD) {
    revenueCounter.inc({ source }, amountUSD);
}
/**
 * Record Riot API call
 */
export function recordRiotApiCall(endpoint, status, durationMs) {
 ...
 */
export function setHealthStatus(component, healthy) {
