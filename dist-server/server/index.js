...
(_c = process.env).BASE_URL ?? (_c.BASE_URL = `http://localhost:${process.env.PORT}`);
// ----- Security Validation -----
...
(async () => {
    try {
        ...
        app.use((err, _req, res, _next) => {
            ...
            const severity = (status >= 500 || message.includes('RIOT_API_KEY')) ? 'critical' : 'warning';
