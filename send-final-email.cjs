// GG LOOP LLC - Early Access Email with Social Links
// Dark theme + roadmap + full social footer
        ...
        <div style="padding: 40px 30px; background-color: #0a0a0a; color: #ffffff;">
          ...
          <div style="border-top: 2px solid #FF6B35; margin: 40px 0 30px 0; padding-top: 30px;">
            ...
            <div style="text-align: center; margin: 0 0 20px 0;">
              <!-- TikTok -->
              <a href="https://www.tiktok.com/@ggloop" style="display: inline-block; margin: 0 10px; text-decoration: none;">
                <div style="background: #1a1a1a; border: 1px solid #333; border-radius: 8px; padding: 12px 16px; display: inline-block; transition: border-color 0.3s;">
                  <span style="color: #FF6B35; font-size: 14px; font-weight: bold;">📱 TikTok</span>
                </div>
              </a>
              ...
              <!-- LinkedIn -->
              <a href="https://www.linkedin.com/company/gg-loop" style="display: inline-block; margin: 0 10px; text-decoration: none;">
                <div style="background: #1a1a1a; border: 1px solid #333; border-radius: 8px; padding: 12px 16px; display: inline-block;">
                  <span style="color: #FF6B35; font-size: 14px; font-weight: bold;">💼 LinkedIn</span>
                </div>
              </a>
            </div>
            ...
            <div style="text-align: center; margin: 20px 0;">
              <!-- Twitter/X -->
              <a href="https://twitter.com/ggloop_io" style="display: inline-block; margin: 0 10px; text-decoration: none;">
                <div style="background: #1a1a1a; border: 1px solid #333; border-radius: 8px; padding: 12px 16px; display: inline-block;">
                  <span style="color: #FF6B35; font-size: 14px; font-weight: bold;">🐦 Twitter</span>
                </div>
              </a>
              
              <!-- Instagram -->
              <a href="https://www.instagram.com/ggloop.io" style="display: inline-block; margin: 0 10px; text-decoration: none;">
                <div style="background: #1a1a1a; border: 1px solid #333; border-radius: 8px; padding: 12px 16px; display: inline-block;">
                  <span style="color: #FF6B35; font-size: 14px; font-weight: bold;">📸 Instagram</span>
                </div>
              </a>
            </div>
            ...
            <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #333;">
              <p style="color: #666; font-size: 12px; line-height: 1.8; margin: 0;">
                ...
                <a href="{{unsubscribe}}" style="color: #666; text-decoration: underline; font-size: 11px;">Unsubscribe</a>
              </p>
            </div>
          </div>
