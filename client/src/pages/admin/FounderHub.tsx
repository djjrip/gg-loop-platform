            ...
            <div>
              ...
              <div className="bg-black/40 border border-white/5 rounded-xl p-6 mb-4">
                  ...
                  <div className="flex gap-2">
                      <Input value="https://discord.gg/Ny7ATHrh" readOnly className="bg-black border-white/10 text-gray-400 font-mono text-sm" />
                      <Button size="icon" variant="ghost" onClick={() => handleCopyLink("https://discord.gg/Ny7ATHrh")}>
