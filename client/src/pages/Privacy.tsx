        ...
        <Card className="p-8 space-y-6 border-primary/20">
          ...
          <section>
            ...
            <ul className="space-y-2 text-muted-foreground list-disc list-inside">
              ...
              <li>You may request deletion of your account by contacting us at info@ggloop.io.</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              If you have questions about this Privacy Policy, contact us at <a href="mailto:info@ggloop.io" className="text-primary hover:underline">info@ggloop.io</a> and include "Privacy" in the subject line.
            </p>
          </section>
        </Card>
