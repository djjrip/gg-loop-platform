        ...
        <Card className="p-8 space-y-6 border-primary/20">
          ...
          <section>
            ...
            <ul className="space-y-2 text-muted-foreground list-disc list-inside">
              ...
              <li>You agree to notify us immediately at info@ggloop.io if you suspect any unauthorized use of your account.</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              For questions about these Terms, contact us at <a href="mailto:info@ggloop.io" className="text-primary hover:underline">info@ggloop.io</a> or visit <a href="https://ggloop.io" className="text-primary hover:underline">ggloop.io</a>.
            </p>
          </section>
        </Card>
