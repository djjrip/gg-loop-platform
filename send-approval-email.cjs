// GG LOOP LLC - Final Email with Correct Social Links
// CORRECTED: Twitter @ggloopllc, Discord invite, LinkedIn
    ...
    <body style="margin: 0; padding: 0; background-color: #0a0a0a;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #0a0a0a; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif;">
        ...
        <div style="padding: 40px 30px; background-color: #0a0a0a; color: #ffffff;">
          ...
          <!-- SOCIAL MEDIA FOOTER -->
          <div style="border-top: 2px solid #FF6B35; margin: 40px 0 30px 0; padding-top: 30px;">
            ...
            <div style="text-align: center; margin: 0 0 20px 0;">
              ...
              <!-- Twitter/X -->
              <a href="https://twitter.com/ggloopllc" style="display: inline-block; margin: 0 8px 12px 8px; text-decoration: none;">
                <div style="background: #1a1a1a; border: 1px solid #1DA1F2; border-radius: 8px; padding: 12px 20px; display: inline-block; min-width: 120px;">
                  <span style="color: #1DA1F2; font-size: 14px; font-weight: bold;">🐦 Twitter</span>
                </div>
              </a>
              
              <!-- LinkedIn -->
              <a href="https://www.linkedin.com/company/ggloop/" style="display: inline-block; margin: 0 8px 12px 8px; text-decoration: none;">
                <div style="background: #1a1a1a; border: 1px solid #0A66C2; border-radius: 8px; padding: 12px 20px; display: inline-block; min-width: 120px;">
                  <span style="color: #0A66C2; font-size: 14px; font-weight: bold;">💼 LinkedIn</span>
                </div>
              </a>
              
              <!-- TikTok -->
              <a href="https://www.tiktok.com/@ggloop" style="display: inline-block; margin: 0 8px 12px 8px; text-decoration: none;">
                <div style="background: #1a1a1a; border: 1px solid #FF0050; border-radius: 8px; padding: 12px 20px; display: inline-block; min-width: 120px;">
                  <span style="color: #FF0050; font-size: 14px; font-weight: bold;">📱 TikTok</span>
                </div>
              </a>
              
              <!-- Instagram -->
              <a href="https://www.instagram.com/ggloop.io" style="display: inline-block; margin: 0 8px 12px 8px; text-decoration: none;">
                <div style="background: #1a1a1a; border: 1px solid #E4405F; border-radius: 8px; padding: 12px 20px; display: inline-block; min-width: 120px;">
                  <span style="color: #E4405F; font-size: 14px; font-weight: bold;">📸 Instagram</span>
                </div>
              </a>
            </div>
            ...
            <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #333;">
              <p style="color: #666; font-size: 12px; line-height: 1.8; margin: 0;">
                ...
                Built from the culture, for the culture.<br><br>
                <a href="https://ggloop.io/privacy" style="color: #888; text-decoration: none;">Privacy Policy</a> • 
                <a href="https://ggloop.io/terms" style="color: #888; text-decoration: none;">Terms of Service</a> • 
                <a href="https://ggloop.io/contact" style="color: #888; text-decoration: none;">Contact Us</a><br>
                <a href="{{unsubscribe}}" style="color: #666; text-decoration: underline; font-size: 11px; margin-top: 10px; display: inline-block;">Unsubscribe</a>
              </p>
            </div>
          </div>
