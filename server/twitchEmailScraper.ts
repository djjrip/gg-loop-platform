 ...
 */
export async function findTwitchEmail(username: string): Promise<EmailResult> {
 ...
 */
export async function findMultipleEmails(usernames: string[]): Promise<EmailResult[]> {
 ...
 */
export function exportToCSV(results: EmailResult[]): string {
...
export { findTwitchEmail, findMultipleEmails, exportToCSV };
